...
def main():
    ...
    URL2DOCIDS_FPATH = './../data/collections/cw22/url2docid/url2docid_txt_cleaned.dat'
    ...
    if "rq" in querysets_to_clean:
        ...
        CLEANED_QUERIES_FPATH = './../data/queries/rq/rq-queries.tsv'
        CLEANED_QRELS_FPATH = './../data/qrels/rq/rq-qrels.tsv'
    ...
    if "msm-ws" in querysets_to_clean:
        ...
        QUERIES_FPATH = "./../data/queries/msmarco-ws/msmarco-ws-queries.tsv"
        CLEANED_QUERIES_FPATH = "./../data/queries/msmarco-ws/cleaned-msmarco-ws-queries.tsv"

        QRELS_FPATH = "./../data/qrels/msmarco-ws/msmarco-ws-qrels.tsv"
        CLEANED_QRELS_FPATH = "./../data/qrels/msmarco-ws/cleaned-msmarco-ws-qrels.tsv"
