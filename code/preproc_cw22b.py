...
def main():
    ...
    RAW_URL2DOCID_FPATH = './../data/collections/cw22/url2docid/url2docid_txt.dat'
    CLEANED_URL2DOCID_FPATH = './../data/collections/cw22/url2docid/url2docid_txt_cleaned.dat'
